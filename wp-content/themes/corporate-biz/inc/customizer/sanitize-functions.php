<?php
/**
 * Corporate Biz Theme Options Sanitization Functions
 *
 ...
 */
function corporate_biz_sanitize_select( $input, $setting ) {
 ...
 */
function corporate_biz_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function corporate_biz_sanitize_post( $input ) {
 ...
 */
function corporate_biz_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function corporate_biz_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function corporate_biz_sanitize_number_range( $number, $setting ) {
